...
# GET INPUTS
anime_url = input("Enter the URL of the 1st episode of the anime from GOGOANIME: ")
...
print("1. 240p  2. 360p  3. 480p  4. 720p  5. 1080p")
highest_quality = int(input("Enter a quality number from 1-5: "))-1
should_download = input("Enter 1 if you want to download the episodes or Enter 2 if you want to only save the episode links to a txt file: ")
...
if highest_quality < 0 or highest_quality > 4:
    print("Error: Invalid quaility mention. Enter only a number from 1-5")
    found_error = True
    ...
    for download_link in all_download_links:
        ...
        while not found_mp4 and req_quality >= 0:
            for mp4 in all_mp4_links:
                if qualities[req_quality] in mp4:
                    found_mp4 = {"link": mp4,
